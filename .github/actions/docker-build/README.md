...
The full action cannot be exercised in this template repository (`validate.yml` path-ignores `.github/actions/**`). End-to-end runtime proof happens on a downstream service fork.
