...
## [1.2.0](https://github.com/Azure/osdu-spi/compare/v1.1.0...v1.2.0) (2026-09-25)
...
* **ci:** Build a paired schema-load image beside the service image ([4cc63be](https://github.com/Azure/osdu-spi/commit/4cc63be08088c3c1c22aa924c88e25efb49fd9d7))
...
* **ci:** Build paired shared-schemas load image ([ade2a66](https://github.com/Azure/osdu-spi/commit/ade2a66598be394a441a01bdcc0675107ac242e9))
* **ci:** Close dependabot bumps that edit upstream-owned files ([047ee51](https://github.com/Azure/osdu-spi/commit/047ee51688deeac1fa4d269297f592c94591de2c))
...
* **dependabot:** Close bumps that edit upstream-owned poms ([03be09b](https://github.com/Azure/osdu-spi/commit/03be09b43589681c61bd133890659d93acf37825))
...
* **fork-resources:** Add a fork contributing guide and script license headers ([56c961c](https://github.com/Azure/osdu-spi/commit/56c961cc4a982ededb4e559edf21d9bca90b00e8))
* **fork-resources:** Add fork contributing guide ([08698fa](https://github.com/Azure/osdu-spi/commit/08698faf878d87ed809099ed09d1e1f736485e9a))
...
* **init:** Plant a fork-owned CODEOWNERS and check it on the settings cadence ([58a6c91](https://github.com/Azure/osdu-spi/commit/58a6c91f9d9c9dd08b37177714d3c7ce606c8b12))
* **init:** Plant fork-owned CODEOWNERS template ([1887c4b](https://github.com/Azure/osdu-spi/commit/1887c4bf77824eee6eb7796118b17bc6b5e0d3e5))
...
* **settings:** Check CODEOWNERS presence and owner resolution ([bbab70a](https://github.com/Azure/osdu-spi/commit/bbab70a6b74e71df776fb9de2c3670e00c2b8d06))
...
* **sync:** Plant missing CODEOWNERS on unchanged template ([671d6dd](https://github.com/Azure/osdu-spi/commit/671d6dde7694dd79ac7a3cebf3278b70d8b2f976))
...
* Authenticate kubelogin release requests ([a5410de](https://github.com/Azure/osdu-spi/commit/a5410de619e80114ed7dad4300d334d6f6757212))
* Authenticate kubelogin release requests ([78c79c5](https://github.com/Azure/osdu-spi/commit/78c79c5b2f368c5b9656155ff879bee7ebec1892))
...
* **ci:** Assert deploy-test SERVICE expression with contains ([ff82570](https://github.com/Azure/osdu-spi/commit/ff825704f12d124ae97a8960901b88a17bb7b91e))
* **ci:** Check upstream-filter config on the base tree ([9e635bd](https://github.com/Azure/osdu-spi/commit/9e635bdb7bd7e0496e289c3d09dc3d2438138634))
...
* **ci:** Pass action path via env in upstream-owned-files ([4ed65f4](https://github.com/Azure/osdu-spi/commit/4ed65f4d2a02dbcec7100df18af9928d2867060e))
* **ci:** Pin deploy lane to descriptor service name ([4efa71b](https://github.com/Azure/osdu-spi/commit/4efa71bd6f1580585efdcd8eae1b873a87ddb1c7))
* **ci:** Pin the deploy lane under the descriptor's service name ([a74d0bc](https://github.com/Azure/osdu-spi/commit/a74d0bc5639888739a1830b8c36d667cf403c1fa))
...
* **ci:** Read port label live in ownership check ([6ae985c](https://github.com/Azure/osdu-spi/commit/6ae985c53ac98af45679012ee2442b39e2560b19))
...
* **ci:** Resolve descriptor before deploy-gate push checks ([3785b0a](https://github.com/Azure/osdu-spi/commit/3785b0a87eb0fee95d825919e119e61562d030a3))
...
* **ci:** Restrict owned-files action to pull_request lane ([db45b31](https://github.com/Azure/osdu-spi/commit/db45b311d418c07baacd43594981752229d53b06))
* **ci:** Restrict ownership-check bypass to same-repo branches ([7241fbd](https://github.com/Azure/osdu-spi/commit/7241fbd977da6bdf534ac530993cb29c9c764588))
...
* **ci:** Stop presetting INITIALIZATION_COMPLETE in fork setup ([ee89e92](https://github.com/Azure/osdu-spi/commit/ee89e928fc91ab765ddcf6dedf8aa7bcc37d3176))
* **ci:** Stop presetting INITIALIZATION_COMPLETE in fork setup ([2654e6c](https://github.com/Azure/osdu-spi/commit/2654e6c179ada15be758ff86d3f7f7452a6e2887))
* **codeowners:** Derive service prefix from provider azure module ([c7ef2ed](https://github.com/Azure/osdu-spi/commit/c7ef2ed9a798b6c41e0c38733e8905fcb18727db))
* **codeowners:** Report CODEOWNERS with no ownership rule ([793e7f0](https://github.com/Azure/osdu-spi/commit/793e7f044c24586f5c1747d0e8aa0362885b20f2))
* **codeowners:** Skip filter fallback when config just planted ([c8891d1](https://github.com/Azure/osdu-spi/commit/c8891d1c5d8c092d3b4a5c580b82437850b7f5b2))
* **codeowners:** Tailor missing-file guidance to sync mode ([e48e505](https://github.com/Azure/osdu-spi/commit/e48e50577289bef748fcaefd8214d6f255082779))
* **codeowners:** Tighten service key parsing in filter config ([b0cfe74](https://github.com/Azure/osdu-spi/commit/b0cfe741f2ac0c0f22f3cb0dea00e865e0372e2d))
...
* **docs:** Handle Mermaid render failures ([68025a3](https://github.com/Azure/osdu-spi/commit/68025a3480adcd7b481c8a880bb964fcbebeada3))
* **docs:** Render Mermaid through Material lifecycle ([34950df](https://github.com/Azure/osdu-spi/commit/34950df12390385ebbefa769233e4bd6715483ba))
* **docs:** Skip rendered Mermaid diagrams ([2534fe9](https://github.com/Azure/osdu-spi/commit/2534fe936e87c67ee956552b10d0601cb892d76f))
* **docs:** Use Material Mermaid lifecycle ([c066c8a](https://github.com/Azure/osdu-spi/commit/c066c8a6e7e83b3305b4abd480218e2dc6540d7b))
...
* **init:** Validate CODEOWNERS inputs before planting ([b386596](https://github.com/Azure/osdu-spi/commit/b38659619da3387ec0b2738f7e9ecc5bf52051f5))
* **java-build:** Run clean verify on the coverage path ([e124b6c](https://github.com/Azure/osdu-spi/commit/e124b6c0897b477b1befce74e75426bb768a82f9))
* **java-build:** Run the Maven lifecycle through verify on pull requests ([1837fe6](https://github.com/Azure/osdu-spi/commit/1837fe66f6cdc385b06c06edb33b4264a6ce9277))
...
* **load-image:** Exchange federated token at Entra v1 endpoint ([747a204](https://github.com/Azure/osdu-spi/commit/747a20423ed267c3bb13774c5edfa08465b90cdd))
* Mint deploy bearer via fresh OIDC exchange ([3d2e509](https://github.com/Azure/osdu-spi/commit/3d2e5099ffe854e0c69ec8ee0153df5f5a986d40))
...
* Reconcile Copilot code review ruleset ([2b72fb8](https://github.com/Azure/osdu-spi/commit/2b72fb87242b1a8c29a0e84950cd90252379ad01))
...
* Resolve upstream version from default branch in release workflow ([7f994d0](https://github.com/Azure/osdu-spi/commit/7f994d07dfedf31fab9a5543e53de51781af9818))
* Resolve upstream version from the real default branch in release.yml ([45ed8a6](https://github.com/Azure/osdu-spi/commit/45ed8a60e3db973a6050e581819e7e5cdf809f46))
...
* **rulesets:** Paginate ruleset lookup in setup-rulesets ([48d33db](https://github.com/Azure/osdu-spi/commit/48d33db710ee5aa2a81214772e94fc3fb1f548f7))
* **settings:** Detect required config via HAVE_* flags ([9dd8619](https://github.com/Azure/osdu-spi/commit/9dd86199f510824cf85bae49532d22122d5511b3))
* **settings:** Detect required config via HAVE_* flags ([775e10c](https://github.com/Azure/osdu-spi/commit/775e10c14c8ef60419b05746435b9b77d4012731))
...
* **sync-template:** Force-add template paths ignored by fork gitignore ([9a82287](https://github.com/Azure/osdu-spi/commit/9a8228739949cad027d8c8f3c756eccda591ad05))
* **sync-template:** Force-add template paths ignored by fork gitignore ([763d9b1](https://github.com/Azure/osdu-spi/commit/763d9b137680a648ce541184f2078bb348874ae6))
...
* Validate descriptor-only pull requests ([f45a316](https://github.com/Azure/osdu-spi/commit/f45a31661694d54fae4844d6353a3bf3ae0f43f0))
* Validate descriptor-only pull requests ([8a22962](https://github.com/Azure/osdu-spi/commit/8a2296231c8030e3aa557770d44bcc188809b9e5))
...
* **adoption:** Correct CODEOWNERS cascade conflict behavior ([c232c14](https://github.com/Azure/osdu-spi/commit/c232c14470b488e34a488ec1e1f45de3f69810b8))
...
* **adr:** Clarify dependabot fork flow in ADR 026 ([804aec4](https://github.com/Azure/osdu-spi/commit/804aec490d7831039a836c6f91bfc59b3406183e))
...
* **adr:** Split em dash clause into a sentence in ADR 004 ([0ad9f6c](https://github.com/Azure/osdu-spi/commit/0ad9f6cbb7c1ce7c879bfb35c4d1517020a54fc5))
...
* **ci:** Note GitHub App install step in fork setup dry run ([0270829](https://github.com/Azure/osdu-spi/commit/02708295f2a901d28e4b21d0cddc10b0b7cc42ab))
...
* Clarify image name comes from SERVICE_NAME or repository ([3424dc8](https://github.com/Azure/osdu-spi/commit/3424dc89bc6008bd857e1d3027d056d95d2787c8))
...
* Correct Check Paths handling of .spi/ changes ([062ba2a](https://github.com/Azure/osdu-spi/commit/062ba2a932bdcf86737dc388998137d785a09478))
...
* Fix issue links in SUPPORT.md to be repo-relative ([40dea7b](https://github.com/Azure/osdu-spi/commit/40dea7b0e8e99d3e3c3ede50b41593ab76b58aab))
* Fix Mermaid rendering lifecycle ([9c629b5](https://github.com/Azure/osdu-spi/commit/9c629b54bc9dc414978577fb649fbd8114e389be))
...
* **java-build:** Move verify rationale next to the mvn call ([76572f5](https://github.com/Azure/osdu-spi/commit/76572f5a3758aa51d801b0d8e06e542be4472070))
...
* **actions:** Remove unused issue-state-manager action ([8f19a6e](https://github.com/Azure/osdu-spi/commit/8f19a6e83d996f30a11efb218ac804464e5fab39))
* **actions:** Remove unused issue-state-manager action ([06959fb](https://github.com/Azure/osdu-spi/commit/06959fb18ebdf18bb54a727ff815cb14ba59e7a0))
* Add Apache 2.0 license headers to scripts ([29902ca](https://github.com/Azure/osdu-spi/commit/29902ca55d9106eaad8bfb19ce11f6343609dc07))
...
* **deps:** Bump openjdk/jdk from `ddb55f5` to `2935b84` in /build in the docker group ([6e7ca03](https://github.com/Azure/osdu-spi/commit/6e7ca03855ec8c780bb1c39e4385ce3e11f5d4f7))
* **deps:** Bump openjdk/jdk in /build in the docker group ([e96a08b](https://github.com/Azure/osdu-spi/commit/e96a08b4e6338981480d55ac65b2dfa314dee44b))
* **deps:** Bump the docker group across 1 directory with 2 updates ([c3c1ed5](https://github.com/Azure/osdu-spi/commit/c3c1ed5b428a9aac59362c7f378320d17f1588a1))
* **deps:** Bump the docker group across 1 directory with 2 updates ([9494611](https://github.com/Azure/osdu-spi/commit/94946118ca6947ffa9cdfea229aeb2f79ed7ace1))
* **deps:** Bump the docker group across 1 directory with 3 updates ([a3d3df7](https://github.com/Azure/osdu-spi/commit/a3d3df797042511e8132d06e200df3afccefabd7))
* **deps:** Bump the docker group across 1 directory with 3 updates ([e9f3a68](https://github.com/Azure/osdu-spi/commit/e9f3a68554cf440b482f66acf5dd6f05c608f786))
* **deps:** Bump the docker group in /build with 2 updates ([d02dda8](https://github.com/Azure/osdu-spi/commit/d02dda8d383fb0e20a229d56ec56104c88082cf0))
* **deps:** Bump the docker group in /build with 2 updates ([a36b5dd](https://github.com/Azure/osdu-spi/commit/a36b5dd80912cf962c0846fa2618a58464ef4e27))
...
* **ci:** Drop issue creation from dependabot validation ([8500068](https://github.com/Azure/osdu-spi/commit/8500068e7cf2bb988fbb6d29965a382237af31f9))
...
* **settings:** Declare required names in arrays ([f1154cf](https://github.com/Azure/osdu-spi/commit/f1154cfa68edc8e3d2cddadc0e54d566c91d236f))
...
* **load-image:** Hard-code payload paths and add QEMU setup ([b6634ab](https://github.com/Azure/osdu-spi/commit/b6634abc297ac3e62739cec0cf407ba0d0919f18))
