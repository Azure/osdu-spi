...
## [1.2.0](https://github.com/Azure/osdu-spi/compare/v1.1.0...v1.2.0) (2026-09-12)
...
* Add borrow, prove, restore deploy lane ([dc3ad07](https://github.com/Azure/osdu-spi/commit/dc3ad074820cfb33d6a644a3071d8ac22be30c35))
* Add entitlements domain fact source ([acbeea4](https://github.com/Azure/osdu-spi/commit/acbeea47f094d7d3861b5c9e1e6c91fb77f9c96c))
...
* **ci:** Decide suite verdicts from surefire and failsafe reports ([ee02d7a](https://github.com/Azure/osdu-spi/commit/ee02d7ac1fe500018f91125937320727b14c8815))
* **ci:** Post validation summary comment on pull requests ([d760477](https://github.com/Azure/osdu-spi/commit/d7604774cf81e3d06939af46b96773f313b5b5a7))
* **ci:** Prove pushed images on the attached stack with a Borrow, Prove, Restore lane ([168588d](https://github.com/Azure/osdu-spi/commit/168588d0ee891cf5b0a884ed8535dd235363167d))
...
* **filter:** Halt when service key is not the module prefix ([2fb31c0](https://github.com/Azure/osdu-spi/commit/2fb31c0fdc508e5e8b5877859520fe6d62229bfe))
...
* **resolver:** Add a noAccessToken source minted by the lane ([8de0de5](https://github.com/Azure/osdu-spi/commit/8de0de59ae18c2b11070ec5dc318b7d701be43cd))
* **resolver:** Add entitlements domain fact source ([080f0b8](https://github.com/Azure/osdu-spi/commit/080f0b8289d6fc5519aa858531547e23287a280d))
* **resolver:** Add memberToken binding source ([cb729ee](https://github.com/Azure/osdu-spi/commit/cb729ee3618191cf9f6ad5c0160130cc81c82885))
* **resolver:** Add memberToken binding source ([4ff667a](https://github.com/Azure/osdu-spi/commit/4ff667a40ba997c40116112022b5386be5152ce2))
* **resolver:** Add noAccessToken binding source ([1ea37f9](https://github.com/Azure/osdu-spi/commit/1ea37f96b613de69fae51577e48c26535c02f2a8))
...
* **ci:** Gate deploy lane on all five onboarding variables ([c8b2bf8](https://github.com/Azure/osdu-spi/commit/c8b2bf863b3ef1aff16306956b8ae66d0543f484))
* **ci:** Gate deploy lane on base_ref for fork_upstream PRs ([2ded02e](https://github.com/Azure/osdu-spi/commit/2ded02e1389efb38296b887b3e53c4a0b8adf19d))
...
* **ci:** Skip summary comment for dependabot and dedupe posts ([d096f19](https://github.com/Azure/osdu-spi/commit/d096f195ee5641f423aff9c1d779894ea13c21f6))
...
* **filter:** Read the module prefix from upstream and widen the superset ([3152cd7](https://github.com/Azure/osdu-spi/commit/3152cd76451f05f1b6e74d3fc8877bbfd8609f4d))
...
* **init:** Close inherited template Dependabot PRs ([4aa04c4](https://github.com/Azure/osdu-spi/commit/4aa04c4d803a5da65b30daf5bf72e85e35b74913))
* **init:** Close inherited template Dependabot PRs ([6c9b1ae](https://github.com/Azure/osdu-spi/commit/6c9b1ae8bfccff2602b2d2ddeccf8ddc5afaa8d3))
...
* **validate:** Poll deployability for up to ten minutes ([01f77b3](https://github.com/Azure/osdu-spi/commit/01f77b3fdc9c5bd822c6bc2b2eb2672a2f751f9a))
* **validate:** Retry the pin when another lane borrows first ([e68906c](https://github.com/Azure/osdu-spi/commit/e68906cbbd54a161320bddf0cd583b1fec0441ec))
* **validate:** Validate spi status JSON before reading fields ([45da8ff](https://github.com/Azure/osdu-spi/commit/45da8ff6dfd42b284454d2e32886310cf151bfe0))
* **validate:** Wait for a borrowed environment and report resolver refusals ([1c14512](https://github.com/Azure/osdu-spi/commit/1c14512643d2bfb6afebc5dba41ee963b5a688f7))
...
* Add deploy lane implementation diagram ([044d2d6](https://github.com/Azure/osdu-spi/commit/044d2d6be6e2592791fe9e3957c6c6b0d79237c0))
* Add fork lifecycle and service descriptor runbooks ([b3d9eec](https://github.com/Azure/osdu-spi/commit/b3d9eec25d74334054531f1812dfa5329b7fa568))
* Add fork lifecycle and service descriptor runbooks ([ebffa7d](https://github.com/Azure/osdu-spi/commit/ebffa7d53daedb47fb4b54a4faf8aead0deb544f))
...
* Align deploy-test design with the shipped lane ([131272f](https://github.com/Azure/osdu-spi/commit/131272fc5947feb96c57d979b5d0f8326cec3556))
* Align deploy-test design with the shipped lane ([9bdd3d3](https://github.com/Azure/osdu-spi/commit/9bdd3d33afb3931395e93d96e0b95170be045099))
...
* Clarify env precedence and portable suite loop ([70b2c20](https://github.com/Azure/osdu-spi/commit/70b2c20d18807c04881a81122f28674b291462cf))
...
* Clarify fork lifecycle and service descriptor runbooks ([513b9b3](https://github.com/Azure/osdu-spi/commit/513b9b38b2461126950eae42f1f93e81bfd95377))
* Clarify fork-owned Azure source in concepts ([d6e84e2](https://github.com/Azure/osdu-spi/commit/d6e84e28c53e0bb396fc8acbc08dc16ece1ca8a1))
* Clarify fork-owned Azure source in concepts ([88ce277](https://github.com/Azure/osdu-spi/commit/88ce277793c58cb01219bc2b1b6b43a555043492))
* Clarify member and no-access test caller wording ([36cad5d](https://github.com/Azure/osdu-spi/commit/36cad5dd64e3f80dd86c90f2422301cdb61e981c))
* Clarify NO_ACCESS_USER_TOKEN in memberToken wording ([ee6cbac](https://github.com/Azure/osdu-spi/commit/ee6cbac8969dc835224b87813be8c9a5b16c818f))
* Clarify service name slug and secrets requirement ([72357f5](https://github.com/Azure/osdu-spi/commit/72357f527eeeec325a3629ffe7b6b051d88f69c0))
...
* Correct binding defaults and suite run commands ([2a73bc0](https://github.com/Azure/osdu-spi/commit/2a73bc032d64233bf5ed1c68097d51d6475be3a6))
* Correct runbook commands and borrow conditions ([9f29800](https://github.com/Azure/osdu-spi/commit/9f29800b99e29ced38c60e15171fbbb11bf6ffa7))
* Distinguish noAccessToken from the NO_ACCESS_USER caller ([1ae964d](https://github.com/Azure/osdu-spi/commit/1ae964df39043acae467e1e1b63a5606c43dc2ce))
...
* Document memberToken as a descriptor binding source ([827668e](https://github.com/Azure/osdu-spi/commit/827668e58930ce6c629dcd9b40c04f1732f9ea66))
* Drop repository deletion step from fork lifecycle ([ab730ce](https://github.com/Azure/osdu-spi/commit/ab730ce53fc00e118d6c1b323432decc6b0509bb))
* Generalize descriptor example with `<service>` placeholder ([777c540](https://github.com/Azure/osdu-spi/commit/777c5400496eecda80f34669619c19a7c9cb3ef7))
...
* Move package cleanup to repository deletion step ([0ac4524](https://github.com/Azure/osdu-spi/commit/0ac45244f597a5925b2f8461b0478e375aabd841))
* Note openid and legalTag facts now published ([b84ea0f](https://github.com/Azure/osdu-spi/commit/b84ea0f0fbc89613daf165ee241f68768fd6d22c))
...
* Record descriptor fallback and unwired lane parts ([3644400](https://github.com/Azure/osdu-spi/commit/36444005d3aac2105bcc48a6aa4373d5f090aa2c))
...
* Use array for maven args in suite run example ([aad0f01](https://github.com/Azure/osdu-spi/commit/aad0f018a324637fe5199f65887f31752ceef467))
...
* **ci:** Add trailing newline to validation summary ([118919f](https://github.com/Azure/osdu-spi/commit/118919f8fef59215bd2de2ac4995eef4eda627f1))
* **validate:** Fix indentation of deploy timeout error block ([2a919eb](https://github.com/Azure/osdu-spi/commit/2a919ebf8bd5e918c3d880040d10c838cb0cb6e4))
...
* **deps:** Bump mkdocs-material from 9.7.0 to 9.7.7 in /doc ([2bf7597](https://github.com/Azure/osdu-spi/commit/2bf7597c171c95c04742cc64c105ef482dff61a7))
* **deps:** Bump mkdocs-material from 9.7.0 to 9.7.7 in /doc ([3af90f2](https://github.com/Azure/osdu-spi/commit/3af90f2807f5abcc499342c4387d790ab82a0866))
...
* Explain skipped docker-push in validation summary ([e1cd05a](https://github.com/Azure/osdu-spi/commit/e1cd05a96418990c2444a72165774bba4def4bf3))
